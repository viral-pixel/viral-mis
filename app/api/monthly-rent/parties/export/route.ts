...
export async function GET() {
  ...
  const buffer = buildMultiSheetXlsxBuffer([
    ...
    },
    {
      ...
      headers: [
        "Party Name", "Site Name", "Due Date", "Proposed Amount", "Requester Remarks", "Raised By", "Raised At",
        "Status", "Paid Amount", "Date Paid", "Admin Remarks", "Paid By",
      ],
      rows: payments.map((e) => [
        e.party.partyName, e.party.siteName, e.dueDate.toISOString().slice(0, 10), e.proposedAmount, e.remarksRequester,
